...
namespace NavalPowerSystems.Drivetrain_V2
{
    public static class Drivetrain_Config
    {
        ...
        {
            {"NPS_Gearbox_MRG", new GearboxStats_V2 { GearRatio = 10f, HasShaftBrake = true, MaxBrakeTorque = 10000 } },
            {"NPS_Gearbox_DoublePlanetary", new GearboxStats_V2 { GearRatio = 10f, HasShaftBrake = true, MaxBrakeTorque = 10000 } },
        };
