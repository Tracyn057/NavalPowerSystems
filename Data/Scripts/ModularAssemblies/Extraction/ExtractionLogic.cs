    ...
    public class ExtractionLogic : MyGameLogicComponent
    {
        ...
        public override void UpdateAfterSimulation100()
        {
            ...
            if (_assemblyId == -1)
            {
                ...
                CommonUtilities.UpdatePowerConsumption(_block, false);
                return;
            }
            ...
            {
                UpdateExtract();
                CommonUtilities.ChangeTankLevel(_outputTank, (double)_extractionRate);
                CommonUtilities.UpdatePowerConsumption(_block, true);
            }
